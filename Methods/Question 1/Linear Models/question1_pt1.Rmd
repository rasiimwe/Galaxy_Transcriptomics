...
```{r}
##Design a matrix considering the variable time and include a quadratic of time to fit a non-linear model:  
...
##Because the filtering function gets rid of the row names we need to set the rownames as a seperate column to not loose the gene.id 
